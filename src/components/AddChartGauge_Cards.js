...
export const AddChartGauge = ({n_id_u}) => {
  ...
  const [TypeChart, setTypeChart] = useState('');//guarda el tipo de chart
  ...
  return (
    <div className='col-12py-2'>
      <div className='row card-chart' style={{margin: '0px'}}>
        ...
        <div className='col-12 pt-3 text-center'>
          <Button variant='contained' color='error' size='small' onClick={()=>DeleteMedidorData()}> <FaTrashAlt /></Button>
          <span>  </span>
          <Button variant='contained' color='success' size='small' onClick={()=>MakeAChart()}> <FaPlus /></Button>
        </div>
      </div>
    </div>
  )
